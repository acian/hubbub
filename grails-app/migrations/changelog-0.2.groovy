databaseChangeLog = {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-1") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-2") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-3") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-4") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-5") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-6") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-7") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-8") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-9") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-10") {
		addPrimaryKey(columnNames: "post_id, tag_id", tableName: "post_tags")
	}

	changeSet(author: "acian (generated)", id: "1459195145985-11") {
		addPrimaryKey(columnNames: "role_id, user_id", constraintName: "user_rolePK", tableName: "user_role")
	}

	changeSet(author: "acian (generated)", id: "1459195145985-21") {
		createIndex(indexName: "user_id_uniq_1459195145875", tableName: "profile", unique: "true") {
			column(name: "user_id")
		}
	}

	changeSet(author: "acian (generated)", id: "1459195145985-22") {
		createIndex(indexName: "authority_uniq_1459195145894", tableName: "role", unique: "true") {
			column(name: "authority")
		}
	}

	changeSet(author: "acian (generated)", id: "1459195145985-23") {
		createIndex(indexName: "login_id_uniq_1459195145896", tableName: "user", unique: "true") {
			column(name: "login_id")
		}
	}

	changeSet(author: "acian (generated)", id: "1459195145985-12") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-13") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-14") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-15") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-16") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-17") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-18") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-19") {
	...
	changeSet(author: "acian (generated)", id: "1459195145985-20") {
