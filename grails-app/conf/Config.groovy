// locations to search for config files that get/home/acian/hubbub/grails-app/conf/BootStrap.groovy:f merged into the main config;
...
grails.exceptionresolver.params.exclude = ['passwordHash']
